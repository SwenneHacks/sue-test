...
TESTS = atoi.c bzero.c # calloc.c itoa.c memccpy.c memchr.c \
	  memcmp.c memcpy.c memmove.c memset.c putchar_fd.c putendl_fd.c \
	  putnbr_fd.c putstr_fd.c split.c strchr.c strdup.c strlcat.c strlcpy.c \
	  strlen.c strncmp.c strrchr.c strtrim.c
